...
<?php 
	...
	$querylistings = mysql_query("SELECT * FROM roomAdvert INNER JOIN hostel ON roomAdvert.hostelID = hostel.hostelID WHERE roomadvert.client_ID = $usermail");
	
	if(($rowsold = mysql_num_rows($querylistings)) > 0){
		while($fetch = mysql_fetch_array($querylistings)){
		?>
                <div class="row">
                <div class="titlebutton"><label><?php echo $fetch['title'];?></label></div>
                </div>
                <div class="row">
                <div class="col-md-4"><div class="listavatar">
                	<?php echo "<img src='".$fetch['mainimage']."' class='img-thumbnail img-responsive' alt='Loading Image...'>"; ?></div>
                </div>
                
                <div class="col-md-5">
                	<div class="col-md-7">
                    <div class="row"><h5>AdvertID: <span class="listcolor value"><?php echo $fetch['roomAdvertID'];?></span></h5></div>
                	<div class="row"><h5>Pricing</h5>
                   <div class="row listcolor"> <?php  echo"<span>Shs	".$fetch['price']."</span>"; ?></div>
                   <div class="row listcolor"><?php  echo"<span>	".$fetch['priceCondition']."</span>"; ?></div>
                	</div></div>
                    <div class="col-md-5">
                	<h4>Posted</h4>
                    <span><?php echo $fetch['advertDate']; ?></span>
                </div>
                
                </div>
                <div class="col-md-3 location">
                	
                    	<a href="actions/delete.php?roomAdvertID=<?php echo $fetch['roomAdvertID']; ?>" class="btn btn-default delete" id="deleteitem">Delete</a>
                        
                    	<a href="update.php?roomAdvertID=<?php echo $fetch['roomAdvertID'];?>&title=<?php echo $fetch['title'];?>" class="btn btn-default action" id="update">Update</a>
		...
		echo "<div class='row' style='height: 374px'><div class='col-md-1'></div> <div class='col-md-9' style='text-align: center; color: red; font-size: 25px;'>No Items Sold Available</div><div class='col-md-1'></div></div>";
	}
?>
</div>
<div class="col-md-1">
