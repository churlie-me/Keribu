...
<title>keribu > roomdetails</title>
	...
	<div class="container">
        ...
        <form  id="postadvert" name="advert" action="../logic/advertise.php"  method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class=" limit2 content1">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                	<p>Only use <b>Digits</b>on entering the number of rooms available</p>
                                	<p><i><b>The Price too should be entered using digits e.g 1000000, donot use any letters or symbols</b></i></p>
            ...
            <div class="row">
                <div class="post">
                    <div class="head1">
                        <label>Rental Specifications</label>
                    </div>
                    <div class=" limit2 content1">
                        <div class="row">
                            <div class="col-sm-9 take">                               
                                ...
                                <div class="form-group reign"> 
                                    ...
                                    <div class="row">       
                                    <input type="text" class="room-control" id="town"  placeholder="e.g Makerere, Mengo, Nakawa etc" name="town"></div>
                                </div>
                                <div class="form-group reign"> 
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div>&nbsp;</div>
                                    <div>&nbsp;</div>
                                    <p>For Sub-town, enter the exact location of the rental, this makes it easier to locate the rental using google Maps</p>
                                </div>
                            </div>
                       </div>
                    </div>
                    ...
                    <div class=" limit2 content1" id="tourselection">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <p>Please Select Specifications Or Services Provided At The Rental</p>
                                </div>
                            </div>
                       </div>
                    </div>
                    ...
                    <div class=" limit2 content1">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <p>Uploading Pictures Portraying The Appearance Of The Room Helps The User Know What The Room Looks Like Before Buying</p><p>Please Choose Images With Shorter Names To Save Space</p>
                                </div>
                            </div>
                       </div>
                    </div>
